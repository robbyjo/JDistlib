...
| --- | --- | --- |
| Variance-gamma, normal-inverse-Gaussian, generalized hyperbolic | Planned for 0.9.0 as one design unit | The 0.9.0 finance roadmap supplies a shared canonical family contract, named parameter conversions, exponentially scaled Bessel audit, characteristic functions, and typed numerical-CDF errors. |
...
| Multivariate gamma, inverse-Gaussian, generalized-hyperbolic, stable and extreme-value laws | Multivariate forms remain deferred | Version 0.9.0 plans the univariate generalized-hyperbolic family and alpha-stable law. Multivariate forms still require separately specified dependence/spectral models and family-specific probability algorithms rather than thin ports. |
...
| Delaporte and Pólya-Aeppli | Planned for the 0.9.0 compound-count design | Both will use the shared compound-sum strategy, tail-error, quantile, and explicit-stream contracts rather than isolated uncertified summation loops. |
