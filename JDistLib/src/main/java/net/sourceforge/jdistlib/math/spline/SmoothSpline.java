 ...
 */
package net.sourceforge.jdistlib.math.spline;

import static java.lang.Math.*;
import static java.util.Arrays.fill;
import static net.sourceforge.jdistlib.math.LinPack.dpbfa;
import static net.sourceforge.jdistlib.math.LinPack.dpbsl;
import static net.sourceforge.jdistlib.math.Constants.kInvGoldRatio;
import static net.sourceforge.jdistlib.math.Constants.M_LN2;
import static net.sourceforge.jdistlib.math.spline.SmoothSplineCriterion.*;
