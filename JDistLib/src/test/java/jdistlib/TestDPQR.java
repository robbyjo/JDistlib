...
//			isEqual(q3, -9.262340089798408, 1e-15);
	...
	public static final boolean test_disttest() {
		...
		double[] result = DistributionTest.mann_whitney_u_test(x, y, 0, true, true, TestKind.GREATER);
		System.out.println(result[0]);
		System.out.println(result[1]);
		success &= isEqual(45, result[0]) && isEqual(0.001953125, result[1]);
		result = DistributionTest.wilcoxon_test(x, 0, true, TestKind.TWO_SIDED);
		System.out.println(result[0]);
		System.out.println(result[1]);
		success &= isEqual(45, result[0]) && isEqual(0.00390625, result[1]);
		...
		System.out.println(result[0]);
		System.out.println(result[1]);
		success &= isEqual(35, result[0]) && isEqual(0.1272061272061272008127, result[1]);
