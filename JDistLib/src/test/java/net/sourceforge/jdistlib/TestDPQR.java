...
import static net.sourceforge.jdistlib.DebugFun.*;
import static net.sourceforge.jdistlib.disttest.DistributionTest.*;
...
import static net.sourceforge.jdistlib.math.MathFunctions.gammafn;
import static net.sourceforge.jdistlib.math.MathFunctions.isInfinite;
import static net.sourceforge.jdistlib.math.MathFunctions.round;
import static net.sourceforge.jdistlib.math.VectorMath.*;
import static net.sourceforge.jdistlib.util.Utilities.c;
import static net.sourceforge.jdistlib.util.Utilities.colon;
import static net.sourceforge.jdistlib.util.Utilities.print;
import static net.sourceforge.jdistlib.util.Utilities.rec;
import static net.sourceforge.jdistlib.util.Utilities.rep;
import static net.sourceforge.jdistlib.util.Utilities.rep_each;
import static net.sourceforge.jdistlib.util.Utilities.rev;
import static net.sourceforge.jdistlib.util.Utilities.sample_int;
import static net.sourceforge.jdistlib.util.Utilities.seq;
