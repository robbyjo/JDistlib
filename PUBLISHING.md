...
SHA-256 checksums, and attaches `jdistlib-all-0.10.2.jar`, the stable
...
```text
git switch --detach v0.10.2
gradlew.bat clean centralBundle '-PreleaseVersion=0.10.2'
```
...
`build/distributions/jdistlib-0.10.2-central.zip`, containing Maven-layout POM,
