...
SHA-256 checksums, and attaches only `jdistlib-all-0.9.0.jar` plus the checksum
...
gradlew.bat clean centralBundle '-PreleaseVersion=0.9.0'
```
...
`build/distributions/jdistlib-0.9.0-central.zip`, containing Maven-layout POM,
